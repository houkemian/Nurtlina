...
本文档记录 Nurtlina Android App 的评分弹窗策略，重点是避免打扰照护场景，不在焦虑、失败或夜间流程中出现，并确保文案不产生医疗或安全保证。
...
> If Nurtlina has been helpful for tracking baby feeds and care, would you like to rate it?
...
> 如果 Nurtlina 帮你更轻松地记录喂奶和宝宝照护，愿意给我们一个评分吗？
